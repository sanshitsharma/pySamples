...
class Solution(object):
    def isAdjacent(self, word1, word2):
        ...
        #print "Checking adjacency for", word1, "with", word2, "dist:", dist
        return dist == 1
    ...
    def ladderLength(self, beginWord, endWord, wordList):
        ...
        while Q:
            curr = copy.deepcopy(Q.pop(0))
            if curr.word == endWord:
                return curr.len
            for it in wordList:
                #print "Evaluating.. ", curr.word, "against", it
                temp = it
                #print "Processing.. curr:", curr, "temp", temp, "wordList:", wordList
                if temp not in visited and self.isAdjacent(curr.word, temp):
                    Q.append(QItem(temp, curr.len+1))
                    #print "Found.. ", temp, "Added to Q:", Q
