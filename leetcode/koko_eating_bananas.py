...
Koko loves to eat bananas.  There are N piles of bananas, the i-th pile has piles[i] bananas. The guards have gone and will come back in
H hours.
...
class Solution(object):
    def minEatingSpeed(self, piles, H):
        ...
        while lo < hi:
            mid = (lo+hi)/2
            if not self.possible(piles, mid, H):
                lo = mid + 1
            else:
                hi = mid
